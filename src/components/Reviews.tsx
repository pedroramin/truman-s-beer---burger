...
export const Reviews = () => {
  return (
    <section className="py-24 bg-dark overflow-hidden" id="reviews">
      <div className="container mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between mb-16 gap-8">
          <div>
            <h2 className="text-4xl md:text-5xl font-extrabold mb-4">O que dizem <br /> <span className="text-primary italic">nossos clientes</span></h2>
          </div>
          <div className="glass p-8 rounded-3xl flex items-center gap-6">
            ...
            <div>
              <div className="text-sm font-bold uppercase tracking-widest text-white/50 mb-1">Ifood Reviews</div>
              <div className="text-xs text-white/30">100+ avaliações reais</div>
            </div>
          </div>
        </div>
